...
| `deploy-to-vercel` | automacao-turbo designer-turbo diretor-criativo-turbo trafego-turbo |
| `design` | designer-turbo diretor-criativo-turbo |
| `design-motion-principles` | diretor-criativo-turbo picasso-auditor-turbo |
...
| `gerador-criativos-vsl` | copywriter-turbo trafego-turbo |
...
| `meta-ads-cli-setup-turbo` | automacao-turbo trafego-turbo |
| `meta-ads-cli-turbo` | automacao-turbo trafego-turbo |
| `oferta-lpsg-turbo` | closer-turbo copywriter-turbo pesquisador-mercado-turbo |
| `operacao-lpsg-turbo` | estrategista-turbo |
