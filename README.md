# LPSG 6.1 · Squad Turbo

> **Coloque seu lançamento pago semanal no ar em menos de 1 semana.**
>
> Método completo · <!--F:n_skills-->40<!--/F--> skills do Claude · <!--F:n_agentes-->13<!--/F--> agents (Squad Turbo + Picasso + Revisor + Closer) · stack Picasso anti-IA · Meta Ads CLI integrada · gate de aprovação narrativa via briefing .docx + Drive · manual interativo HTML com 5 seções passo-a-passo.
...
[![Skills: 40](https://img.shields.io/badge/skills-40-orange.svg)](#skills)
...
<!--F:n_skills-->40<!--/F--> skills proprietárias (principais abaixo · lista canônica em `99-skills-compartilhaveis/sync-skills.sh`). Instale em `~/.claude/skills/`:
...
```
✅ <!--F:n_skills-->40<!--/F--> skills proprietárias instaladas e testadas
✅ 13 agents (Squad Turbo + Picasso + Revisor + Closer)
✅ 10 estruturas com template + exemplo preenchido
✅ 52 zips compartilháveis (40 skills + squad completo + squad-core + 10 templates)
