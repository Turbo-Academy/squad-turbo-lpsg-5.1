...
>
> Método completo · <!--F:n_skills-->42<!--/F--> skills do Claude · <!--F:n_agentes-->13<!--/F--> agents (Squad Turbo + Picasso + Revisor + Closer) · stack Picasso anti-IA · Meta Ads CLI integrada · gate de aprovação narrativa via briefing .docx + Drive · manual interativo HTML com 5 seções passo-a-passo.
...
<!--F:n_skills-->42<!--/F--> skills proprietárias (principais abaixo · lista canônica em `99-skills-compartilhaveis/sync-skills.sh`). Instale em `~/.claude/skills/`:
...
```
✅ <!--F:n_skills-->42<!--/F--> skills proprietárias instaladas e testadas
✅ 13 agents (Squad Turbo + Picasso + Revisor + Closer)
✅ 10 estruturas com template + exemplo preenchido
✅ 54 zips compartilháveis (42 skills + squad completo + squad-core + 10 templates)
